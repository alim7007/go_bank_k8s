...
// Source: github.com/alim7007/go_backend_bank/db/sqlc (interfaces: Store)
...
// DelteAccount mocks base method.
func (m *MockStore) DelteAccount(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DelteAccount", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DelteAccount indicates an expected call of DelteAccount.
func (mr *MockStoreMockRecorder) DelteAccount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DelteAccount", reflect.TypeOf((*MockStore)(nil).DelteAccount), arg0, arg1)
}
